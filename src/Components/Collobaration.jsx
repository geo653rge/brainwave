    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          <p
            className="body-2 mb-8 text-n-4 md:mb-16 lg:mb-32
          ...
          >
            <div className="flex w-60 m-auto border border-n-6 rounded-full aspect-square">
            ...
            <ul>
              {collabApps.map((app, index) => (
                <li
                  key={app.id}
                  className={`top-0 absolute left-1/2 h-1/2 -ml-[1.6rem] origin-bottom
                rotate-${index * 45}`}
                >
                  <div

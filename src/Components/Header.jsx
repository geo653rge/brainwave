...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 w-full bg-n-8/90
    z-50  border-b border-n-6 lg:bg-n-8/90
     lg:backdrop-blur-sm left-0 ${
...
lg:mx-auto lg:bg-transparent lg:justify-between`}
        >
          <div
            className="relative z-2 flex flex-col items-center justify-center
    m-auto lg:flex-row lg:justify-between"
          >
            {navigation.map((item) => (
              <a
                key={item.id}
